...
ActiveRecord::Schema.define(:version => 20130521175650) do
  ...
  create_table "campaigns", :force => true do |t|
    ...
    t.text     "application_credits_text"
    t.string   "references_received_mail_from"
    t.string   "references_received_mail_subject"
    t.text     "references_received_mail_text"
  end
